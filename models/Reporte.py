...
class Reporte:
    def __init__(self, tipo_reporte, fecha_generacion=None):
        ...
        # Ahora el reporte almacena sus partes por separado
        self.encabezado = ""
        self.cuerpo = ""
        self.pie_pagina = ""
    ...
    def contenido_completo(self):
        """Ensambla visualmente las partes construidas por el Builder"""
...
class ReporteAcademicoBuilder(IReporteBuilder):
    ...
    def construir_cuerpo(self, datos):
        # Transforma una lista de datos en texto estructurado
...
class DirectorReportes:
    ...
    def generar_reporte_calificaciones(self, estudiante_nombre, notas):
        self.builder.reset("Académico - Calificaciones")
        self.builder.construir_encabezado("Historial de Calificaciones", estudiante_nombre)
